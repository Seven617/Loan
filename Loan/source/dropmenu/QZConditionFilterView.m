...
- (void)prepareUIWithBtn:(UIButton *)btn
{
    ...
    if (btn == _dataSource1Btn) {
        _filterTableView1 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, navH+40, self.width, 0)];
        ...
        _filterTableView2 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, navH+40, self.width, 0)];
...
- (void)prepareBgView
{
    ...
    if (_bgView)  return;
    _bgView = [[UIView alloc] initWithFrame:CGRectMake(0, navH+self.y+self.height, self.width, SCREEN_HEIGHT-(self.y+self.height))];
