...
- (void)setUpGFScrollMenUI {
    // 创建图片
    self.iconImageView = [[UIImageView alloc] initWithFrame:CGRectMake(UIScreen.mainScreen.bounds.size.width/8-25, 0, 50, 50)];
...
////        make.width.equalTo(self.mas_width).offset(-43);
//
